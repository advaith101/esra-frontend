                  ...
                  <v-menu max-width="120px">
                      ...
                      <v-list v-if="selectedEntities.length" >
                        <v-list-item
                          ...
                          :key="index"
                          @click="updateTotalActivityValue(item)"
                ...
                <v-flex lg12 xs12>
                  ...
                  >
                    <v-expansion-panel class="documentpanel" >
                      ...
                      <v-expansion-panel-content >
                        <hr />
                        <DocInsightChart ref="documentChart"
                        :selectedEntities="selectedEntitiesforDocument" :dateRange="dateRange" :timeMode="timeMode" :selectedApps="selectedApps"  />
                      </v-expansion-panel-content>
                    </v-expansion-panel>
                  </v-expansion-panels>
                   </div>
            ...
            <v-col cols="12" style="margin-top:-25px" >
                  ...
                  >
                    <v-expansion-panel style="height:260px">
                      ...
                      <v-expansion-panel-content>
                        <hr />
                       <ComparisonBarChart @updateComparisonBarChartTitle="updateComparisonBarChartTitle" ref="comparisonChart"
                       :selectedEntities="selectedEntitiesforComparison" :dateRange="dateRange" :timeMode="timeMode" :selectedApps="selectedApps"  />
                      </v-expansion-panel-content>
                    </v-expansion-panel>
                  </v-expansion-panels>
                    </div>
              ...
              <v-expansion-panel>
                  ...
                  <v-menu max-width="120px">
                      ...
                      <v-list v-if="selectedEntities.length" >
                        <v-list-item
                          v-for="(item, index) in activities"
                          :key="index"
                          @click="updateRadarActivityValue(item)"
                ...
                <v-expansion-panel-content>
                  ...
                  <VueSlickCarousel :arrows="true" :dots="true" style="margin-bottom:10px;">
                    ...
                    <div>
                      <AppTable :selectedEntities="selectedEntitiesforActivity" :dateRange="dateRange" :selectedApps="selectedApps" :timeMode="timeMode" :mode="selectedActivityforTotal" />
                    </div>
                  </VueSlickCarousel>
                </v-expansion-panel-content>
              </v-expansion-panel>
...
<style scoped>
.pagelayout{
  background-color:#FAFAFA;margin-top:11px;overflow:hidden;
}
.filter {
  display: flex;
  flex-direction: row;
